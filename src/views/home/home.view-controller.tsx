    ...
    <div className='ink-wash min-h-screen bg-neutral-950 text-neutral-200'>
      <div className='pointer-events-none fixed inset-0 z-0 overflow-hidden'>
        <GameImage
          ...
          src={inkLandscape}
          visibleByDefault
          wrapperClassName='absolute left-1/2 top-0 block w-[110rem] max-w-none -translate-x-1/2 opacity-[0.14]'
        />
        <GameImage
          alt='水墨山水底紋'
          className='h-auto w-full'
          src={inkLandscape}
          visibleByDefault
          wrapperClassName='absolute bottom-[-8rem] right-[-12rem] block w-[72rem] max-w-none opacity-[0.1]'
        />
      </div>
